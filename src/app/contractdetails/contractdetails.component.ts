...
export class ContractdetailsComponent implements OnInit {
  ...
  contractDetails(){
       this.http.get(localStorage.getItem("LandRegistryURL")+"getPropertyDetailsFromBc/"+localStorage.getItem("contractAddress"))
       .subscribe(
         d=>{
   ...
   getBuyerDetails(){
    this.http.get(localStorage.getItem("LandRegistryURL")+"getConfirmBuyerDetailsFromBc/"+localStorage.getItem("contractAddress"))
    .subscribe(
      d=>{
